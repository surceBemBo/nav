...
return {
Lock     = '• من ← '..UserInfousername..'\n'..TextMsg,
unLock   = '• من ← '..UserInfousername..'\n'..TextMsg,
lockKtm  = '• من ← '..UserInfousername..'\n'..TextMsg..'\n• خاصيه الكتم ',
lockKid  = '• من ← '..UserInfousername..'\n'..TextMsg..'\n• خاصيه التقييد ',
lockKick = '• من ← '..UserInfousername..'\n'..TextMsg..'\n• خاصيه الطرد ',
...
if Redis:get(FDFGERB.."FDFGERB:Lock:text"..msg_chat_id) and not • رابط الحذف لجميع مواقع تواصل.  then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
...
if ReplyFilters and not msg.TheBasics then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
return LuaTele.sendText(msg_chat_id,msg_id,"• ابشر تم لغيت كلشي ","md",true)   
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم حفظ رد للمدير  \n• ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"• مبروك فزت  وخمنت الرقم الصحيح\n🚸|تم اضافة  5  من النقاط \n","md",true)  
...
elseif text == 'الاحصائيات' or text == 'حصه' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• المجموعه : ['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..') \n• تم تفعيل اريك استمتع  ','md', true, false, false, false, reply_markup)
end
end 
...
if text == "ايدي" or text == "id" and msg.reply_to_message_id == 0 then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• ايديك هو ← '..msg.sender.user_id,"md",true)  
end
if text == "اسمي"  then
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• اسمك هو ←'..ban.first_name,"md",true)
end
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص : ( '..Controller_Num(3)..' , مالك القروب ',"md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• ما اقدر استعمل الامر ع بوت !! ","md",true)  
end
if TextMsg == 'MY' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله MY مسبقا ").Reply,"md",true)  
else
Redis:srem(FDFGERB.."FDFGERB:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله MY").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم تنزيله M  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته MY مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:DevelopersQ:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• ابشر رفعته MY ").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته M مسبقا ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:Developers:Groups",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم ترقيته M ").Reply,"md",true)  
end
end
if TextMsg == "مالك اساسي" then
if LuaTele.getChatMember(msg_chat_id,msg.sender.user_id).status.luatele ~= "chatMemberStatusCreator" and not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• مرفوع مالك اساسي من اول  ").Reply,"md",true)  
else
Redis:sadd(FDFGERB.."FDFGERB:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• ابشر رفعته مالك اساسي ").Reply,"md",true)  
end
end
if TextMsg == "مالك اساسي" then
if not msg.Developers then
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• مرفوع مالك  من اول  ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• مرفوع مدير من اول  ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• مرفوع ادمن من اول  ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• ابشر رفعته مميز  مسبقا ").Reply,"md",true)  
else
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '- مسح قائمه MY', data = msg.sender.user_id..'/DevelopersQ'},},}}
...
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {{{text = '', data = msg.sender.user_id..'/TheBasics'},},}}
return LuaTele.sendText(msg_chat_id, msg_id, ListMembers, 'md', false, false, false, false, reply_markup)
end
...
Redis:set(FDFGERB.."FDFGERB:Status:gamle"..msg_chat_id,true) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم تفعيل اريك بلقروبات ","md",true)
end
...
Redis:del(FDFGERB.."ardode:Set:Rd"..msg.sender.user_id..":"..msg.chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n- Dev🎖️   : ['..UserInfo.first_name..'](tg://user?id='..UserInfo.id..')',"md",true)  
end
end
...
data = {
{
{text = '❲ Source Eric ❳', url = "https://t.me/LDD7D"}
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id,"[𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑻𝒐 𝑺𝒐𝒖𝒓𝒄𝒆 𝑬𝒓𝒊𝒄  ..]\n","md",true, false, false, false,reply_markup)
end
...
if TextMsg == 'جمالي' then
Redis:del(FDFGERB.."FDFGERB:Status:gamle"..msg_chat_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم كتمه عام  . ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم الغاء كتمه عام  .   ").Reply,"md",true)  
end
end
...
if StatusCanOrNotCan(msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,"\n• هييه مايمديك تقيده   "..Controller(msg_chat_id,UserId_Info.id).."  ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• هييه مايمديك تقيده   "..Controller(msg_chat_id,Message_Reply.sender.user_id).."  ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• هييه مايمديك تقيده   "..Controller(msg_chat_id,UserId[3]).."  ","md",true)  
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• هذا بالع عام من قبل  ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• تم لقم من المجموعات  ").Reply,"md",true)  
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• ابشر كتمته في المجموعه مسبقا ").Reply,"md",true, false, false, false, reply_markup)
else
Redis:sadd(FDFGERB.."FDFGERB:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"• ابشر كتمته في المجموعه  ").Reply,"md",true, false, false, false, reply_markup)
end
end
...
data = {
{
{text = 'اي', data = '/Zxchq'..msg_chat_id}, {text = 'لا', data = msg.sender.user_id..'/Redis'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"تم تفعيل أمر all ").Lock,"md",true)  
return false
end 
...
local Text ='• تم اختيار غنيه لك  '
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '❲ 𝑺𝒐𝒖𝒓𝒄𝒆 𝑬𝒓𝒊𝒄  . ❳',url="t.me/LDD7D"}},
}
...
if text == "قران" or text == "شغل قران" then
Abs = math.random(2,140); 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"• ابشر تم قفلت صور").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"• ابشر تم قفلت صور").lockKid,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"• ابشر تم قفلت صور").lockKtm,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"• ابشر تم قفلت صور").lockKick,"md",true)  
return false
end 
...
data = {
{
{text = '• قناة السورس', url = 't.me/LDD7D'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,"\n• يهطف ما بتقدر تنزل نفس رتبتك او اعلى منك  ","md",true)  
end
Redis:srem(FDFGERB.."FDFGERB:Developers:Groups",Message_Reply.sender.user_id)
Redis:srem(FDFGERB.."FDFGERB:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id)
Redis:srem(FDFGERB.."FDFGERB:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id)
...
return LuaTele.sendText(msg_chat_id,msg_id,"• تم مسح ( "..#Info_Members.." ) من المنشئين الاساسيين ","md",true)
end
...
if photo.total_count > 0 then
local TestText = "  ❲ Eirc 𝖲𝗈𝗎𝗋𝖼𝖾 ❳\n— — — — — — — — —\n• Ace Name :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n• Ace Bio : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝑺𝒐𝒖𝒓𝒄𝒆 𝑬𝒓𝒊𝒄 . ❳', url = "https://t.me/LDD7D"}
},
}
local msg_id = msg.id/2097152/0.5 
...
keyboardd.inline_keyboard = {
{
{text = '❲ Ace  ❳', url = "https://t.me/EE3WW"}
},
{
{text = '❲ 𝑺𝒐𝒖𝒓𝒄𝒆 𝑬𝒓𝒊𝒄 . ❳', url = "https://t.me/kzzzp"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if not Redis:get(FDFGERB.."FDFGERB:Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
data.inline_keyboard = {
{
{text = 'اخفاء افتارك  ', callback_data = msg.sender.user_id..'/delAmr'}, 
},
{
{text = '', callback_data= msg.sender.user_id..'/ban1'}, 
},
}
local msgg = msg_id/2097152/0.5
...
{
{text = ' اوامر Dev   ', data = msg.sender.user_id..'/help5'}, {text = ' الالعاب ', data = msg.sender.user_id..'/help6'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع مالك ')
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع مالك اساسي')
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'MY','رفع MY')
...
{
{text = 'تفعيل اريك بلمجموعات •',type = 'text'},{text = 'تعطيل البوت الخدمي •', type = 'text'},
},
{
...
if text == 'تفعيل اريك بلمجموعات •' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
{
{text = ' اوامر Dev   ', data = IdUser..'/help5'}, {text = ' الالعاب ', data = IdUser..'/help6'}, 
},
{
...
local TextHelp = [[
✶ اهلا بك في اوامر المالك الاساسي
— — — — — — — — —
• رفع ، تنزيل ← مالك  
