...
return LuaTele.sendText(msg_chat_id,msg_id,'• تم رفع الملف بنجاح الان اكتب تحديث')
end 
end
...
local Text ='• تم ايقاف الميزه برمضان '
keyboard = {} 
