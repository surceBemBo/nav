...
if text == 'تغيير ملكيه البوت' or text == 'تغيير C' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص { '..Controller_Num(1)..' }* ',"md",true)  
end
...
if text == "تفعيل غنيلي" and Manager(msg) and ChCheck(msg) or text == "تفعيل الغنيلي" and Manager(msg) and ChCheck(msg) then
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تفعيل الغنيلي'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:del(FDFGERB..'Hid:Remix:Hid'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الغنيلي" and Manager(msg) and ChCheck(msg) then
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تعطيل الغنيلي'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:set(FDFGERB..'Hid:Remix:Hid'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غني ⌔") and not DevHid:get(FDFGERB..'Hid:Remix:Hid'..msg.chat_id_) and ChCheck(msg) then
Hid = math.random(2,612); 
local Text ='*⌔︙  تم اختيار الغنيلي لك*'
keyboard = {}  
...
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تفعيل المتحركه'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:del(FDFGERB..'Hid:gif:Hid'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تعطيل المتحركه'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:set(FDFGERB..'Hid:gif:Hid'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ⌔") and not DevHid:get(FDFGERB..'Hid:gif:Hid'..msg.chat_id_) and ChCheck(msg) then
...
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تفعيل الانمي'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:del(FDFGERB..'Hid:Anime:Hid'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تعطيل الانمي'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:set(FDFGERB..'Hid:Anime:Hid'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ⌔") and not DevHid:get(FDFGERB..'Hid:Anime:Hid'..msg.chat_id_) and ChCheck(msg) then
...
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تفعيل الصوره'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:del(FDFGERB..'Hid:Photo:Hid'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local FDFGERB = '⌔︙  اهلا عزيزي ↫ '..HidRank(msg)..' \n⌔︙  تم تعطيل الصوره'
Hidmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, FDFGERB, 14, string.len(msg.sender_user_id_))
DevHid:set(FDFGERB..'Hid:Photo:Hid'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ افتار ⌔") and not DevHid:get(FDFGERB..'Hid:Photo:Hid'..msg.chat_id_) and ChCheck(msg) then
...
data = {
{
{text = '❲ Source Miles ❳', url = "https://t.me/kzzzp"}
},
{
{text = '❲ Master🎖¹ ❳', url = "https://t.me/EE3WW"}
},
{
...
if text == "غادر"..NamesBot, or text == "  برا اطلع" then 
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
{
{text = ' اوامر Carbon ', data = msg.sender.user_id..'/help5'}, {text = ' الالعاب ', data = msg.sender.user_id..'/help6'}, 
},
{
...
if text == 'ناقص' then
katu = {'م','ر','ي','ت','ص','خ','ظ','ط','ا','ه','ف','ل','ق','ب','و','ج','ن','ع','ت','ش','ك','ح','د','ء','};.  --السؤال
name = katu[math.random(#katu)]
Redis:set(FDFGERB..'FDFGERB'..msg.chat_id,name)
name = string.gsub(name,'م','مح_د')
name = string.gsub(name,'ر','سيا_ة')
name = string.gsub(name,'ي','طباش_ر')
name = string.gsub(name,'ت','ريمو_')
name = string.gsub(name,'ص','_داع')
name = string.gsub(name,'ح','ب_اخ')
name = string.gsub(name,'ظ','محف_ة')
name = string.gsub(name,'ي','مند_ل')
name = string.gsub(name,'م','مطع_')
name = string.gsub(name,'ط','مع_ر')
name = string.gsub(name,'ا','ستار_ة')
name = string.gsub(name,'ا','دول_ب')
name = string.gsub(name,'ا','سم_عة')
name = string.gsub(name,'ي','بطان_ة')
name = string.gsub(name,'ط','ب_ارية')
name = string.gsub(name,'ه','فا_ي')
name = string.gsub(name,'ف','ت_اح')
name = string.gsub(name,'ر','زه_ة')
name = string.gsub(name,'ل','جمي_ة')
name = string.gsub(name,'ق','برت_ال')
name = string.gsub(name,'ب','ثعل_')
name = string.gsub(name,'م','لي_ون')
name = string.gsub(name,'و','صند_ق')
name = string.gsub(name,'ص','غوا_ة')
name = string.gsub(name,'ج','درا_ة')
name = string.gsub(name,'ن','سفي_ة')
name = string.gsub(name,'و','_رده')
name = string.gsub(name,'ع','شجا_')
name = string.gsub(name,'ا','جب_ن')
name = string.gsub(name,'ت','كمبيو_ر')
name = string.gsub(name,'ه','ج_از')
name = string.gsub(name,'ي','ط_ار')
name = string.gsub(name,'ش','_اشة')
name = string.gsub(name,'ب','الكع_ة')
name = string.gsub(name,'ك','ال_لية')
name = string.gsub(name,'ح','السل_فاة')
name = string.gsub(name,'ف','مكي_')
name = string.gsub(name,'ج','دجا_')
name = string.gsub(name,'ع','طاب_ة')
name = string.gsub(name,'و','حاس_ب')
name = string.gsub(name,'و','سك_تر')
name = string.gsub(name,'د','مستو_ع')
name = string.gsub(name,'ا','مط_ر')
name = string.gsub(name,'د','ضف_ع')
name = string.gsub(name,'ه','_اتف')
name = string.gsub(name,'ا','حص_ن')
name = string.gsub(name,'م','ت_ساح')
name = string.gsub(name,'ء','ببغا_')
name = string.gsub(name,'ط','طما_م')
name = string.gsub(name,'ي','ياسم_ن')


return SENDD(msg.chat_id,msg.id,'  جمع - مفرد ↤︎ ( '..name..' ) ' )
end

if Redis:get(FDFGERB..'FDFGERB'..msg.chat_id) then 
if text == Redis:get(FDFGERB..'FDFGERB'..msg.chat_id) then
Redis:incrby(FDFGERB..'FDFGERB'..msg.chat_id..msg.sender.user_id,2)  
Redis:del(FDFGERB..'FDFGERB'..msg.chat_id)
return SENDD(msg.chat_id,msg.id,albat )
end
end
...
name = string.gsub(name,'🇺🇾','اورغواي')

return SENDD(msg.chat_id,msg.id,'  اكمل ↤︎ ( '..name..' ) ' )
end

if Redis:get(FDFGERB..'FDFGERB'..msg.chat_id) then 
if text == Redis:get(FDFGERB..'FDFGERB'..msg.chat_id) then
Redis:incrby(FDFGERB..'FDFGERB'..msg.chat_id..msg.sender.user_id,1)  
Redis:del(FDFGERB..'FDFGERB'..msg.chat_id)
return SENDD(msg.chat_id,msg.id,albat )
end
end
...
if text == 'مصطلح' then
katu = {'كرسي','باب','موية','عصير','طباشير','منديل','بخاخ','معطر','بلايستيشن','يد','كرتون','جوال','شاحن','زرافه','ملك','كمامه','بطانيه','مبنى'};.  --السؤال
name = katu[math.random(#katu)]
Redis:set(FDFGERB..'FDFGERB'..msg.chat_id,name)
name = string.gsub(name,'ملك','ملك')
name = string.gsub(name,'زرافه','زرافه')
name = string.gsub(name,'شاحن','شاحن')
name = string.gsub(name,'جوال','جوال')
name = string.gsub(name,'كرتون','كرتون')
name = string.gsub(name,'يد','يد')
name = string.gsub(name,'بلايستيشن','بلايستيشن')
name = string.gsub(name,'معطر','معطر')
name = string.gsub(name,'بخاخ','بخاخ')
name = string.gsub(name,'معطر','معطر')
name = string.gsub(name,'منديل','منديل')
name = string.gsub(name,'طباشير','طباشير')
name = string.gsub(name,'عصير','عصير')
name = string.gsub(name,'موية','موية')
name = string.gsub(name,'باب','باب')
name = string.gsub(name,'كرسي','كرسي')
name = string.gsub(name,'مبنى','مبنى')
name = string.gsub(name,'بطانيه','بطانيه')
name = string.gsub(name,'كمامه','كمامه')

return SENDD(msg.chat_id,msg.id,'  الكلمه ↤︎ ( '..name..' ) ' )
end
...
if text == 'عربي' then
katu = {'جوال','اسد','ابواب','سجادات','قاضي','سياكل','قرد','برتقالات','ضروس','شاحن','أسرة','ثلث','تجربه','بلبل','تحف','أمر','أخت','ثريات' };

name = katu[math.random(#katu)]
Redis:set(FDFGERB..'FDFGERB'..msg.chat_id,name)
name = string.gsub(name,'امر','اوامر') -- السؤال بطن والجواب بطون
name = string.gsub(name,'تحف','تحفه')
name = string.gsub(name,'بلبل','بلابل')
name = string.gsub(name,'تجربه','تجارب')
name = string.gsub(name,'ثلث','اثلاث')
name = string.gsub(name,'أسرة','اسر')
name = string.gsub(name,'شاحن','شواحن')
name = string.gsub(name,'ضروس','ضرس')
name = string.gsub(name,'برتقالات','برتقال')
name = string.gsub(name,'قرد','قرود')
name = string.gsub(name,'سياكل','سيكل')
name = string.gsub(name,'قاضي','قضاه')
name = string.gsub(name,'سجادات','سجادة')
name = string.gsub(name,'ابواب','باب')
name = string.gsub(name,'اسد','اسود')
name = string.gsub(name,'جوال','جوالات')
name = string.gsub(name,'ثريات','ثريا')
name = string.gsub(name,'أخت','اخوات')
...
return LuaTele.sendText(msg_chat_id,msg_id,'• اهلا بك عزيزي Carbon and Master🎖 ', 'md', false, false, false, false, reply_markup)
end
end
if text == 'تنظيف المشتركين •' then
if not msg.ControllerBot then 
...
{
{text = ' اوامر Carbon ', data = IdUser..'/help5'}, {text = ' الالعاب ', data = IdUser..'/help6'}, 
},
{
