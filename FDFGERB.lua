...
data = {
{
{text = 'اي', data = Message_Reply.sender.user_id..'/zog1'},{text = 'لا', data = Message_Reply.sender.user_id..'/zog2'}, 
},
}
}
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-› تم تنزيله Mمسبقا ").Reply,"md",true)  
else
...
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"-› تم ترقيته MY").Reply,"md",true)  
end
end
if TextMsg == 'M' then
if not msg.DevelopersQ then
...
return LuaTele.sendText(msg_chat_id,msg_id,"[𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑻𝒐 𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒂𝒊𝒍𝒆𝒔 ..]\n","md",true, false, false, false,reply_markup)
end
...
data = {
{
{text = '', data = msg.sender.user_id..'/unbanktmkid@'..UserId_Info.id},
},
}
}
...
data = {
{
{text = '', data = msg.sender.user_id..'/unbanktmkid@'..Message_Reply.sender.user_id},
},
}
}
...
data = {
{
{text = '', data = msg.sender.user_id..'/unbanktmkid@'..UserId},
},
}
}
...
if text == "غادر" or text == "بوت اطلع " then 
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n-› الامر يخص ( '..Controller_Num(2)..' ) ',"md",true)  
end
if ChannelJoin(msg) == false then
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم قفل الاضافه").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم قفل الدخول ").Lock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم فتح الاضافة ").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم فتح الدخول ").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم فتح التثبيت ").unLock,"md",true)  
return false
end 
...
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"- تم فتح التعديلات").unLock,"md",true)  
return false
end 
...
Redis:del(FDFGERB.."FDFGERB:Lock:edit"..msg_chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"-  تم فتح تعديل الميديا").unLock,"md",true)  
return false
end 
...
return LuaTele.sendText(msg_chat_id,msg_id,"-› حسناً , الان ارسل كلمه الرد ","md",true)  
end
if text == "حذف رد" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n-› الامر يخص : ( '..Controller_Num(7)..' ) ',"md",true)  
...
if photo.total_count > 0 then
local TestText = "  ❲ 𝖲𝗈𝗎𝗋𝖼𝖾 𝖬𝗂𝗅𝖾𝗌 ❳\n— — — — — — — — —\n-› Master Name :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n-› Master Bio : [❲ "..Bio.." ❳]"
keyboardd = {} 
...
data = {
{
{text = '- فتح الهَمسة', data = msg.sender.user_id..'/showwhisper'},
},
}
}
...
data.inline_keyboard = {
{
{text = '', callback_data = msg.sender.user_id..'/delAmr'}, 
},
{
{text = 'تغيير الافتار', callback_data= msg.sender.user_id..'/ban1'}, 
},
}
local msgg = msg_id/2097152/0.5
...
{
{text = '➌', data = msg.sender.user_id..'/help3'},
},
{
{text = 'اوامر Dev', data = msg.sender.user_id..'/help4'}, {text = 'اوامر التسليه', data = msg.sender.user_id..'/help5'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '', data = msg.sender.user_id..'/Haiw4'}, },}}
...
return LuaTele.sendText(msg.chat_id,msg.id, "• المهر لازم اكثر من 1000ريال 💸\n","md",true)
end
...
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• ما بتقدر تضارب الآن\n• تعال بعد "..rr.." دقيقة") 
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• الحد الادنى المسموح هو 200ريال 💸\n-","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
...
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• ما بتقدر تستثمر الآن\n• تعال بعد "..rr.." دقيقة") 
end
...
rr = oger(check_time)
return LuaTele.sendText(msg.chat_id, msg.id,"• ما بتقدر تلعب لعبة الحظ الآن\n• تعال بعد "..rr.." دقيقة") 
end
LuaTele.sendText(msg.chat_id,msg.id, "استعمل الامر كذا :\n\n`حظ` المبلغ","md",true)
end
...
Redis:del(FDFGERB.."trans" .. msg.chat_id .. ":" .. msg.sender.user_id) 
Redis:del(FDFGERB.."transn" .. msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• ما بتقدر تحول لنفسك ","md",true)
end
...
Redis:sadd(FDFGERB.."ttpppi",msg.sender.user_id)
return LuaTele.sendText(msg.chat_id,msg.id,"• خذ بخشيش المحظوظين 3000ريال 💸","md",true)
end
...
return LuaTele.sendText(msg.chat_id,msg.id, "• ما بتقدر تزرفه فلوسه اقل من 2000 ريال 💸","md",true)
end
...
Redis:set(FDFGERB.."FDFGERB:Get:Reides:Commands:Group"..msg_chat_id..":"..'M','رفع M')
...
return LuaTele.sendText(msg_chat_id,msg_id,'-› اهلا بك عزيزي Dev and Master🎖 ', 'md', false, false, false, false, reply_markup)
end
end
if text == 'تنظيف المشتركين -›' then
if not msg.ControllerBot then 
