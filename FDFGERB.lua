...
{
{text = 'LONER', url='https://t.me/LZDDD'},
},
}
}
...
data = {
{
{text = '❲ Source LONER ❳', url = "https://t.me/LZDDD"}
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,"[LONER Source](t.me/LZDDD)\n\n[Source Manger](t.me/EE3WW)","md",true, false, false, false,reply_markup)
end
