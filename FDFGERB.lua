...
return {
Lock     = '• بواسطه ← '..msg.Name_Controller..'\n'..TextMsg..'\n• خاصيه المسح ',
unLock   = '• بواسطه ← '..msg.Name_Controller..'\n'..TextMsg,
lockKtm  = '• بواسطه ← '..msg.Name_Controller..'\n'..TextMsg..'\n• خاصيه الكتم ',
lockKid  = '• بواسطه ← '..msg.Name_Controller..'\n'..TextMsg..'\n• خاصيه التقييد ',
lockKick = '• بواسطه ← '..msg.Name_Controller..'\n'..TextMsg..'\n• خاصيه الطرد ',
Reply    = '• المستخدم ← '..msg.Name_Controller..'\n'..TextMsg..''
}
end
...
return LuaTele.sendText(msg_chat_id,msg_id,"𝑾𝒆𝒍𝒄𝒐𝒎𝒆 𝑻𝒐 𝑺𝒐𝒖𝒓𝒄𝒆 𝑴𝒂𝒊𝒍𝒆𝒔 ..","md",true, false, false, false,reply_markup)
end
